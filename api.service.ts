...
export class ApiService {
  ...
  galleryURL = 'flickr.photos.search&api_key=' + this.API_KEY + '&media=photos&extras=url_c';
  photoInfo = 'flickr.photos.getInfo&api_key=' + this.API_KEY + '&extras=url_c';

  constructor(private http: HttpClient) { }

  getGallery(tag: String): any {
    return  this.http.get<any>(this.BASE_URL+this.galleryURL+'&tags='+tag+this.FORMAT);
  }
